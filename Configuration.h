...
#define STRING_CONFIG_H_AUTHOR "(Biketrial981, default config)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Anycubic 1.4"
 ...
 */
 #define NOZZLE_PARK_FEATURE
  ...
  #define NOZZLE_PARK_POINT { 75,45,160 }
#endif
