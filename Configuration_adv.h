...
#define ADVANCED_PAUSE_FEATURE
  ...
  #define PAUSE_PARK_XY_FEEDRATE 1100          // X and Y axes feedrate in mm/s (also used for delta printers Z axis)
  #define PAUSE_PARK_Z_FEEDRATE 1100             // Z axis feedrate in mm/s (not used for delta printers)
  #define PAUSE_PARK_RETRACT_FEEDRATE 100      // Initial retract feedrate in mm/s
  ...
  #define FILAMENT_CHANGE_LOAD_LENGTH 800       // Load filament length over hotend in mm
